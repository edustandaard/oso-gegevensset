...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:od="http://www.edustandaard.nl/oso_gegevensset/2018/dossier" xmlns="http://www.edustandaard.nl/oso_gegevensset/2018/schemas/Meldingen" exclude-result-prefixes="xs" version="2.0" extension-element-prefixes="od">
  ...
  <xsl:template match="//od:dossier/od:metadata">
    ...
    <!-- _______________________________________________________ -->
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.MD01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.MD02 -->
    <!-- Veld validatieversie heeft waarde "2018.1.1" -->
    <!-- 20180102 aanpassing volgende regel aan actuele versie -->
    <xsl:if test="($typeDocument='swv-dossier') and  not(od:validatieversie='2018.1.1')">
      <xsl:call-template name="melding">
        <xsl:with-param name="tekst">De validatieversie is niet correct voor deze versie van de standaard.</xsl:with-param>
      </xsl:call-template>
    </xsl:if>
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.MD03 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.SO01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.SO02 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.SO03 -->
  ...
  <xsl:template match="od:huidigeschool">
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.SL01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.SL02 -->
  ...
  <xsl:template match="od:leerling">
    ...
    <!-- ________________________________________________________ -->
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL02 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL03 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL04 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL05 (=ALGEMEEN?) -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL06 (=ALGEMEEN?) -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL07 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL08 (=ALGEMEEN?) -->
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.OV04 (=ALGEMEEN?) -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL09 (=ALGEMEEN?) -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL10 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL11 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.LL12 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VV01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VV02 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VV03 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VV04 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.EB01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.OV01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VM01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VM02 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VM03 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VM04 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VM05 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VM06 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.VM07 -->
  ...
  <xsl:template match="od:verzorger">
    ...
    <!-- ________________________________________________________ -->
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.OV03 (=ALGEMEEN?)-->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.OV05 (=ALGEMEEN?)-->
  ...
  <xsl:template match="od:zorg">
    ...
    <!-- ___________________________________________________ -->
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.ZB01 -->
    ...
    <!-- Afspraak OSO gegevensset + SWV-profielen versie 2018.1, business rule PaO.ZB02 -->
