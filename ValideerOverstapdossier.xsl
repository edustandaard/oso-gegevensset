...
<!--20140509: validatie van veld Herzien VO advies (herzienadvies) toegevoegd -->
<!--20140417: verplichting van communicatiegegevens bij leerling vervallen (zie business rule OS.L05) -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:od="http://www.edustandaard.nl/oso_gegevensset/1.1/dossier" xmlns="http://www.edustandaard.nl/oso_gegevensset/1.1/schemas/Meldingen" exclude-result-prefixes="xs" version="2.0" extension-element-prefixes="od">
  ...
  <xsl:template match="/">
    <meldingen>
      ...
      <!--<xsl:for-each select="/descendant::*/od:metadata/od:eldversie">
				<xsl:if test="not(text()='1.1.1')">
					<xsl:call-template name="melding">
						<xsl:with-param name="tekst">Het veld 'Versienummer van afspraak' bevat een waarde die niet gelijk is aan de verplichte waarde "1.1.1".</xsl:with-param>
					</xsl:call-template>
				</xsl:if>
			</xsl:for-each>-->
      ...
      <xsl:for-each select="/descendant::*/od:overstapadvies/od:profiel">
        <xsl:if test="not(text()='basis') and not(text()='plus') and not(text()='bespreek') and not(text()='disharmonisch')">
          <xsl:call-template name="melding">
      ...
      <xsl:for-each select="/descendant::*/od:tlv/od:tlvcategorie">
        <xsl:if test="not(text()='H') and not(text()='M') and not(text()='L')">
          <xsl:call-template name="melding">
      ...
      <!-- VANAF NU, validatie van Afspraak OSO gegevensset + overstapprofielen + overdrahct-binnen-brin profiel versie 1.1-->
      <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.I01 -->
  ...
  <xsl:template match="od:metadata">
    <!-- Afspraak OSO gegevensset + overstapprofielen + binnen-brin versie 1.1, business rule OS.M01 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.M02 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.M03 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.M04 -->
  ...
  <xsl:template match="//od:inzage">
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.I02 -->
    <!--In een overstapdossier moet de inzage node aanwezig zijn.-->
    <!-- 20131128 volgende regel toegevoegd -->
    <xsl:if test="($typeDocument='overstapdossier') and not(xs:boolean(//od:inzage/od:inzage))">
      <xsl:call-template name="melding">
        <xsl:with-param name="tekst">Elk overstapdossier moet zijn ingezien door ouders/verzorgers, ofwel het veld 'Inzage ouders' moet waarde "Ja" bevatten.</xsl:with-param>
      </xsl:call-template>
    </xsl:if>
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.I03 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.I04 -->
  ...
  <xsl:template match="od:huidigeschool">
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.S01 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.S02 -->
  ...
  <xsl:template match="od:leerling">
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L01 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L02 -->
    <!-- In een overstapdossier is bij leerling voornaam verplicht -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L03 -->
    <!-- In een overstapdossier is bij leerling voornaam verplicht -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L04 -->
    ...
    <xsl:if test="($typeDocument='overstapdossier') and ($heeftLAS='Y') and not(od:adreslijst/od:adres) and not(od:adresbuitenland)">
      <xsl:call-template name="melding">
        <xsl:with-param name="tekst">Minimaal één Nederlands of buitenlands adres is verplicht bij een leerling.</xsl:with-param>
      </xsl:call-template>
    </xsl:if>
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L05 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L06 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L07 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L08 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L09 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L10 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L11 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L12 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L13 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L14 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.L15 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.O01 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.T01 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.V01 -->
  ...
  <xsl:template match="od:overstapadvies">
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.O02 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.O03 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.O04 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.O05 -->
  ...
  <xsl:template match="od:toets">
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.T04 -->
  ...
  <xsl:template match="od:zorg">
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.Z01 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.Z02 -->
    ...
    <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.Z03 -->
  ...
  <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.T05 -->
  ...
  <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.T06 -->
  ...
  <xsl:template match="od:toetsscore">
    <xsl:if test="($typeDocument='overstapdossier') and not(od:aantalgoed) and not(od:aantalfout) and not(od:aantalgelezen) and not(od:tijd) and not(od:vaardigheidsscore)">
      <xsl:call-template name="melding">
        <xsl:with-param name="tekst">Een toetsscore moet minimaal het aantal goed, het aantal fout, het aantal gelezen, de tijd of de vaardigeheidsscore bevatten.</xsl:with-param>
      </xsl:call-template>
    </xsl:if>
    <xsl:apply-templates/>
  </xsl:template>
  <!-- Afspraak OSO gegevensset + overstapprofielen versie 1.1, business rule OS.C01 -->
